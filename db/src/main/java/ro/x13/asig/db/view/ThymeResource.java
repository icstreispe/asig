...
import ro.x13.asig.db.view.model.FieldView;

import java.util.ArrayList;
import java.util.List;

import static ro.x13.asig.db.view.model.FieldType.LIST;
import static ro.x13.asig.db.view.model.FieldType.TEXT;
